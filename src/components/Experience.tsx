...
export default function Experience() {
  return (
    <section id="experience" className="relative border-t border-line bg-panel/20">
      <div className="mx-auto max-w-[1440px] px-6 py-28 md:px-12 md:py-40">
        <SectionHeading index="03" eyebrow="Career / Timeline" title="Where I've" accent="shipped code" />
          ...
          {experience.map((job, i) => (
            ...
            >
              ...
              <div className="lg:col-span-3 lg:pl-4">
                ...
                <div className="mt-3 font-mono text-xs uppercase tracking-[0.2em] text-mute">{job.period}</div>
              ...
              <div className="lg:col-span-9 lg:pr-4">
                <div className="flex flex-wrap items-baseline justify-between gap-3">
                  <h3 className="text-3xl font-bold tracking-tight text-cream transition-colors group-hover:text-lime md:text-4xl">
                    {job.role}
                  </h3>
                  <span className="font-serif text-xl italic text-mute">{job.company}</span>
                </div>
